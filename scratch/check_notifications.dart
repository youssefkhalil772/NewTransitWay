...
void main() async {
  ...
  const url = 'https://vrgcsoeepbwnedzjwiqb.supabase.co/rest/v1/notifications?limit=3';
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (json is List) {
        print('TOTAL RECORDS: ${json.length}');
        if (json.isNotEmpty) {
          print('KEYS: ${json[0].keys.toList()}');
          print('FIRST RECORD: ${json[0]}');
        }
      } else {
        print('Not a list: $responseBody');
      }
    } else {
