...
void main() async {
  ...
  print('--- Bus Info ---');
  final bus = await http.get(Uri.parse('https://vrgcsoeepbwnedzjwiqb.supabase.co/rest/v1/buses?id=eq.bccc6eb2-9cb2-4f93-8f81-b59a266fdeb3&select=id,bus_number'), headers: headers);
  print(bus.body);
}
